...
import me.darkboy.titaniumcore.system.inventory.opener.ChestInventoryOpener;
import me.darkboy.titaniumcore.system.inventory.opener.InventoryOpener;
import me.darkboy.titaniumcore.system.inventory.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<Player, TitaniumInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(TitaniumInventory inv) {
    ...
    public Optional<TitaniumInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p));
    }

    protected void setInventory(Player p, TitaniumInventory inv) {
        if(inv == null)
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            TitaniumInventory inv = inventories.get(p);
