...
public class TitaniumConfig {
    ...
    public TitaniumConfig(String path, String fileName) {
    ...
    public Location getLocation(String path) {
        ...
        return new Location(Bukkit.getWorld(Objects.requireNonNull(fileConfig.getString(path + ".World"))), fileConfig.getDouble(path + ".X"), fileConfig.getDouble(path + ".Y"), fileConfig.getDouble(path + ".Z"), (float) fileConfig.getDouble(path + ".Yaw"), (float) fileConfig.getDouble(path + ".Pitch"));
    }
